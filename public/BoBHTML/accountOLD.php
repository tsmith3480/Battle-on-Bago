			...
			<fieldset class="AccountDetails">
				...
				<?php
					...
					try {
						...
						echo ('
							<p><span class="label">First Name: </span>' . $fName . '</p>
							<p><span class="label">Last Name: </span>' . $lName . '</p>
							<p><span class="label">Address: </span>' . $Address . '</p>
							<p><span class="label">City: </span>' . $City . '</p>
							<p><span class="label">State: </span>' . $State . '</p>
							<p><span class="label">Zip Code: </span>' . $Zip . '</p>
							<p><span class="label">Email Adress: </span>' . $Email . '</p>
